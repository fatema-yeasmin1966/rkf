...
<html lang="bn-BD">
  ...
  <body>
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light ">
              ...
              <a class="navbar-brand logoo" href="#"><img src="images/Logo 1.png" width="100px" style="margin-right: 130px"></a>
...
<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
 ...
 <div class="container">
 	<div class="row">
 		<div class="water col-md-12 col-12 col-sm-12 text-info bg-primary shadow-1-strong">
 			<h3 class="col-md-10 col-sm-10 col offset-md-4 mt-2 text-info text-white">Donation</h3>
                 ...
                 ?>
                  ...
                  <tbody>
                     <tr>
                         ...
                         <!-- jodi user num count korte chai tahole ei code
                          <td><?php echo $valuesS->sanitization; ?></td> -->
