...
<html lang="bn-BD">
  ...
  <body>
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light ">
              ...
              <a class="navbar-brand logoo" href="http://localhost/Rasheda_Khanam_Foundation/asset/index.php"><img src="images/Logo 1.png" width="100px" style="margin-right: 130px"></a>
...
<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
 ...
 <div class="container">
 	<div class="row">
 		<div class=" card col-md-12 col-12 col-sm-12 text-info bg-primary shadow-1-strong">
 			<h3 class="offset-md-4 text-info text-white mt-2">Donation</h3>
